...
class AttackerPlanner(ValueIteration):
    def __init__(self, mdp,  max_iterations=500, sample_rate=3):
    ...
    def get_q_value(self, s, a):
        ...
        expected_val = 0
        #print (self.trans_dict[s][a].keys())
        for s_prime in self.trans_dict[s][a].keys():
            #Only change made to this function: comment out print statement.
            '''
            print(s, a, s_prime,
    ...
    def _compute_max_qval_action_pair(self, state):
        ...
        print("Attacker max q val: ", max_q_val)
